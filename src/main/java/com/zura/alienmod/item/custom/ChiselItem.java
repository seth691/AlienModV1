...
import com.zura.alienmod.component.ModDataComponents;
...
public class ChiselItem extends Item {
    ...
    private static final Map<Block, Block> CHISEL_MAP =
            Map.of(
                    ...
                    Blocks.NETHERRACK, ModBlocks.BJ_BLOCK.get()
            );
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        if(Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip.alienmod.chisel.shift_down"));
        } else {
            tooltipComponents.add(Component.translatable("tooltip.alienmod.chisel"));
        }
