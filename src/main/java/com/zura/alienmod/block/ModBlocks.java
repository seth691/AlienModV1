...
public class ModBlocks {
    public static DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(AlienMod.MOD_ID);

    public static final DeferredBlock<Block> BJ_BLOCK = registerBlock("bj_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(3f).sound(SoundType.SLIME_BLOCK)));
    ...
    public static final DeferredBlock<StairBlock> BISMUTH_STAIRS = registerBlock("bismuth_stairs",
            () -> new StairBlock(ModBlocks.BJ_BLOCK.get().defaultBlockState(),
